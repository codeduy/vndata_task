...
* Luồng **D**: **n9ecenter** sẽ lưu các thông tin như users, notify_rule, datasource, alert_rule, alert_his_event,... vào **MySQL** dựa trên thao tác của user ở giao diện webUI.
